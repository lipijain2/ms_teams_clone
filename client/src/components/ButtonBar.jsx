      ...
      <span style = {{ display: 'absolute', marginLeft: '10%' }}>
        ...
        {isVideoOn ? (
          <Button 
            ...
            startIcon = { <Videocam style={{fontSize:30}}/> } 
            onClick={() => { setIsVideoOn(!isVideoOn); switchVideoOff();} }>
          </Button>
        ):(
          <Button  
            style = {{ 
            ...
            startIcon = { <VideocamOff style={{fontSize:30}}/> } 
            onClick = { () => { setIsVideoOn(!isVideoOn); switchVideoOn();} }>
          </Button>
        )}
        {' '}
        { isScreenOn ? (
        ...
        { !callEnded && callAccepted && (
          <Button  
            ...
            startIcon = { <PhoneDisabled style={{fontSize:30}} /> } 
            onClick = { leaveCall } >
          </Button>
        )}  
        </span>
