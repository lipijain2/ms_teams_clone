...
export default function Registration() {
  ...
  return (
    <div className='App'>
      <h1 style = {{fontSize:'60px', color: '#FFFFFF', fontFamily: 'Akaya Kanadaka'}}>
        <strong>
          <center>
            HOWZDATT
            <Button
      ...
      <div>
        <div class="row row-style" style={{width: '100%', display: 'flex', marginTop: '100px'}}>
          ...
          <div className="col-md-6 login" style={{width: '50%'}}>
            <center>
              <h2 style={{fontSize:'20px', color: '#FFFFFF', fontFamily: 'Varela Round', marginBottom: '10px'}}>
                <strong>
                  Already have an account?
                </strong>
              </h2>

              <h2 style={{fontSize:'35px', color: '#FFFFFF', fontFamily: 'Varela Round', marginBottom: '30px'}}>
                <strong>
                  LOG IN
                </strong>
              </h2>
